...
export const metadata = {
  ...
  description:
    "Four event spaces at Malejor, Accra. A garden for 2,000 guests, a large naturally ventilated auditorium, an air-conditioned executive hall and a terrace. Catering, beverages and floral.",
};
